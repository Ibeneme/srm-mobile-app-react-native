...
interface StakeholdersNotificationProps {
  senderName: string;
  message: string;
  onPress:  () => void;
}

const StakeholdersNotification: React.FC<StakeholdersNotificationProps> = ({
  senderName,
  message,
  onPress
}) => {
  ...
  const handleNotificationPress = () => {
   // navigation.navigate('StakeholdersDetails' as never);
...
export default StakeholdersNotification;
